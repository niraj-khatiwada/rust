fn main() {
    ...
    let mut car2 = String::from("Red");
    {
        let ref3 = &mut car2; // This mutable reference only exists for this block.
        println!("{ref3}");
    }
    let ref4 = &mut car2; // This still works because the above mutable reference will be deallocated before running this line.
    println!("{ref4}");
